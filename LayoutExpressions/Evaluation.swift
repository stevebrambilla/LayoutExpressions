...
public func evaluateLayoutExpression(_ expression: ExpressionType) -> [NSLayoutConstraint] {
...
///
/// Returns an array of layout constraints.
public func evaluateLayoutExpressions(_ expressions: [ExpressionType]) -> [NSLayoutConstraint] {
